...
/**
 * @classDescription CircularProgressBarView
 * @date 2013年12月16日 上午17:53:59
 * @author 邢如更
 * 
 */
public class CircularProgressBarView extends View {
	...
	private void initAttrs(Context context, AttributeSet attrs) {
		...
		mRadius = typedArray.getDimension(
				R.styleable.circularProgressBar_radius1, 50);
		mStrokeWidth = typedArray.getDimension(
				R.styleable.circularProgressBar_strokeWidth1, 10);
		mCircleColor = typedArray.getColor(
				R.styleable.circularProgressBar_circleColor1, 0x00000000);
		mRingColor = typedArray.getColor(
				R.styleable.circularProgressBar_ringColor1, 0xffffffff);
