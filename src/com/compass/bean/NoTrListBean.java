 ...
 *       "ERRCODE":0}
 */
public class NoTrListBean extends EntityBase {

	public NoTrListBean(int ERRCODE, String ERRMSG) {
		super(ERRCODE, ERRMSG);
		// TODO Auto-generated constructor stub
	}

	private List<NoTrBean> DATA;

	public List<NoTrBean> getDATA() {
		return DATA;
	}

	public void setDATA(List<NoTrBean> DATA) {
		this.DATA = DATA;
	}
