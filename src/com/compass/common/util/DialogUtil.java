...
public class DialogUtil {
	public static Dialog getLoginDialog(Activity context, int stringId) {
		...
		titleTxtv.setText(stringId);
		return dialog;
	}

	public static Dialog getLoginDialog(Activity context, String string) {
